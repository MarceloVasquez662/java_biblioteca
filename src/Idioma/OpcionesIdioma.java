 ...
 * @author 20017181-0
 */
public class OpcionesIdioma extends javax.swing.JFrame {

    /**
     * Creates new form OpcionesAutor
     */
    public OpcionesIdioma() {
        initComponents();
    ...
    private void initComponents() {
        ...
        radioInsertar.setText("Insertar Idioma");

        buttonGroup1.add(radioModificar);
        radioModificar.setText("Modificar Nombre Idioma");

        buttonGroup1.add(radioEliminar);
        radioEliminar.setText("Eliminar Idioma");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(radioInsertar.isSelected() || radioModificar.isSelected() || radioEliminar.isSelected() || radioMostrarTodos.isSelected())
        {
            ...
            {
                InsertarIdioma x=new InsertarIdioma();
                x.setVisible(true);
                dispose();
            }
            ...
            {
                EliminarIdioma x=new EliminarIdioma();
                x.setVisible(true);
                dispose();
            }
            if(radioMostrarTodos.isSelected())
            {
                MostrarTodosIdiomas x=new MostrarTodosIdiomas();
                x.setVisible(true);
                dispose();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpcionesIdioma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OpcionesIdioma().setVisible(true);
            }
        });
    }
