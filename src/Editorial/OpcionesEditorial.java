 ...
 * @author 20017181-0
 */
public class OpcionesEditorial extends javax.swing.JFrame {

    /**
     * Creates new form OpcionesAutor
     */
    public OpcionesEditorial() {
        initComponents();
    ...
    private void initComponents() {
        ...
        radioInsertar.setText("Insertar Editorial");

        buttonGroup1.add(radioModificar);
        radioModificar.setText("Modificar Editorial");

        buttonGroup1.add(radioEliminar);
        radioEliminar.setText("Eliminar Editorial");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(radioInsertar.isSelected() || radioModificar.isSelected() || radioEliminar.isSelected() || radioMostrarTodos.isSelected())
        {
            ...
            {
                InsertarEditorial x=new InsertarEditorial();
                x.setVisible(true);
                dispose();
            }
            ...
            {
                EliminarEditorial x=new EliminarEditorial();
                x.setVisible(true);
                dispose();
            }
            if(radioMostrarTodos.isSelected())
            {
                MostrarTodasEditoriales x=new MostrarTodasEditoriales();
                x.setVisible(true);
                dispose();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpcionesEditorial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OpcionesEditorial().setVisible(true);
            }
        });
    }
